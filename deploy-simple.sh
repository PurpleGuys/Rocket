...
# Create production .env with Neon database
cat > .env << 'ENV'
NODE_ENV=production
PORT=3000
DATABASE_URL=postgresql://neondb_owner:npg_yYpqrHGOG1Ai@ep-crimson-cherry-a2aorb8z.eu-central-1.aws.neon.tech/neondb?sslmode=require
